  ...
  return (
    <section className={`speech-controls ${compact ? "speech-controls--compact" : ""}`} aria-label={title}>
      ...
      <div className="speech-controls__actions">
        ...
        <button type="button" className="button button--quiet" onClick={() => setRate(0.88)}><RotateCcw size={15} aria-hidden="true" />Reset speed</button>
      </div>
      ...
      <p className="speech-controls__boundary">
        This is synthetic speech generated by the voice installed on this device. It is not a reviewed human recitation and does not preserve Vedic accents.
      </p>
      <p className="speech-controls__voice">
        {speech.supported ? `Voice: ${speech.activeVoice || "selected when playback starts"}` : "This browser does not expose speech synthesis."}
      </p>
