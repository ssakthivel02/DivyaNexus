 ...
 * It keeps compliance routes visible without forcing a tall mobile endpoint.
 */
...
const footerGroups = [
  ...
  { title: "Study", links: [["Ask Divya", "/ask-divya"], ["Life Guidance", "/life-guidance"], ["Glossary", "/glossary"], ["Sources", "/sources"], ["About", "/about"]] },
  { title: "Support & legal", links: [["Privacy", "/privacy"], ["Terms", "/terms"], ["AI Disclaimer", "/disclaimer"], ["Delete Account", "/delete-account"], ["Contact", "/contact"]] },
] as const;

export function SiteFooter() {
  return (
    <footer className="site-footer">
      <div className="site-footer__topline"><span>DIVYANEXUS / LIVING ARCHIVE</span><span aria-hidden="true" /><Link href="/sources">Read our source approach <ArrowUpRight size={14} aria-hidden="true" /></Link></div>
